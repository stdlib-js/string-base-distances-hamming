...
```javascript
hammingDistance = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/string-base-distances-hamming@v0.2.3-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/string-base-distances-hamming@v0.2.3-umd/browser.js"></script>
```
